package ru.mirea.muravievvr.cryptoloader;
...
import ru.mirea.muravievvr.cryptoloader.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.button.setOnClickListener(v -> {
            String text = String.valueOf(binding.editTextCrypto.getText());
